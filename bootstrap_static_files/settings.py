# Django settings for bootstrap_static_files project.
import os
...
SECRET_KEY = '7*dqvx$@%q_d4)0+5x=-gdtl)v2_nxndil2y6((v(mpt(_)s*!'
...
ROOT_URLCONF = 'bootstrap_static_files.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'bootstrap_static_files.wsgi.application'
